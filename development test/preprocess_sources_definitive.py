...
recommendations_df.to_excel('dataset_entrenamiento1.xlsx') #aquí se genera luego de procesada la data y hacer un match apropiado, un excel con el top de recomendaciones por usuario
...
recommendations_df['conversation'] = recommendations_df['prompt'] + ' ' + recommendations_df['completion']
